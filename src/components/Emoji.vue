...
export default {
  ...
  methods: {
    ...
    giveMeARandomEmoji: function() {
      var emoji = {}
      //console.log("here")
      emoji.code = this.emojiList[Math.floor((Math.random() * this.totalemoji))];
